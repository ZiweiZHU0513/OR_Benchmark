"""miplib-nl LP evaluation that skips sufficiency checking after WL matching."""
...
check_lp_equivalence_no_sufficiency = _equiv_mod.check_lp_equivalence_no_sufficiency
...
def evaluate_one(
    ...
    equivalence_success, equivalence_msg, time_info = check_lp_equivalence_no_sufficiency(
    ...
    return {
        ...
        "sufficiency_assumption": "SKIPPED_ASSUME_TRUE",
    }
...
def main():
    ...
    parser.add_argument("--save_path", default="results/miplib-nl/gpt-4o_no_sufficiency.json")
    ...
    lp_output_dir = os.path.abspath(os.path.join("temp_lp", f"{base_model_name}_miplib_nl_no_sufficiency"))
